...
import com.hrbat.master.micronaut.api.HealthApi;
import com.hrbat.master.micronaut.model.SuccessResponse;
...
public class HealthApiService implements HealthApi {
    ...
    public SuccessResponse healthCheck() {
        ...
        //credentialsProducer.sendMessage("Hello kafka from authservice");
