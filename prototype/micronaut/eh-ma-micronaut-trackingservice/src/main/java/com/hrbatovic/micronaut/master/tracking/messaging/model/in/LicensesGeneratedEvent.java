...
import com.hrbatovic.micronaut.master.tracking.messaging.model.in.payload.LicensePayload;
...
public class LicensesGeneratedEvent implements Serializable {
    ...
    public LicensesGeneratedEvent setSourceService(String sourceService) {
